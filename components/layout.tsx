...
export function Layout({ children, activeRoute }: PropsWithChildren<LayoutProps>) {
  ...
  return (
    <>
      ...
      <main className="p-8 flex flex-col align-center justify-center width-full m-auto pb-32 max-w-[770px] md:max-w-[990px] lg:max-w-[1220px]">
        <Link href="/">
          <p className="mt-4 mb-8 font-light text-4xl uppercase sm:text-5xl sm:mt-20 sm:mb-14">
            {t('home-header')}
          </p>
        </Link>
        <nav className="flex flex-col gap-3 align-center mb-16 sm:flex-row sm:mb-24">
